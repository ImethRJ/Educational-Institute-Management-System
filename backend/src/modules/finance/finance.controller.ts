...
export class FinanceController {
  ...
  @ApiOperation({ summary: 'Trigger monthly invoice generator engine with 0% attendance suppression' })
  ...
  @Post('payments')
  @ApiOperation({ summary: 'Record student payment & execute automatic teacher revenue split engine' })
  async recordPayment(
  ...
  @Get('payments')
  @ApiOperation({ summary: 'Get list of payment records with student & teacher split details' })
