...
export class ProcessTeacherPayoutDto {
  @ApiProperty({ example: 'c39a82e1-4567-4b12-8901-23456789abcd', description: 'Teacher ID' })
  ...
  @ApiPropertyOptional({ example: 'Monthly earnings settled via bank transfer', description: 'Payout notes' })
  @IsOptional()
  @IsString()
  notes?: string;
}
