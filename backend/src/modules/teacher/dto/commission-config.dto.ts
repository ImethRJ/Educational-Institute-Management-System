...
export class UpdateCommissionConfigDto {
  @ApiProperty({ example: 75.0, description: 'Default monthly tuition fee commission percentage (0-100)' })
  ...
  @ApiPropertyOptional({ enum: CommissionType, example: CommissionType.PERCENTAGE, description: 'Admission fee commission type' })
  @IsOptional()
  @IsEnum(CommissionType)
  admissionCommissionType?: CommissionType;

  @ApiPropertyOptional({ example: 20.0, description: 'Admission fee commission value' })
  @IsOptional()
