...
export class TeacherController {
  ...
  @Get()
  @ApiOperation({ summary: 'Get list of teachers with optional search and status filter' })
  ...
  @Put(':id/commission')
  @ApiOperation({ summary: 'Configure teacher tuition and admission fee commission rules' })
  ...
  @Get(':id/earnings')
  @ApiOperation({ summary: 'Get teacher earnings and commission breakdown by month' })
