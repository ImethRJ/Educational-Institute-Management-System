...
export class CreateScheduleDto {
  ...
  @ApiProperty({
    example: 6,
    description: "Day of week (1=Monday, 6=Saturday, 7=Sunday)",
  })
  ...
  @ApiProperty({
    example: "08:00",
    description: "Class start time in HH:mm 24-hour format",
  })
  ...
  @ApiProperty({
    example: "10:30",
    description: "Class end time in HH:mm 24-hour format",
  })
