...
export class AcademicController {
  ...
  @Get("subjects")
  @ApiOperation({
    summary: "Get list of subjects with optional grade level filter",
  })
  ...
  @Get("batches/:id")
  @ApiOperation({
    summary: "Get detailed batch class profile and enrolled students",
  })
  ...
  @Post("schedules")
  @ApiOperation({
    summary: "Create a timetable class schedule slot with collision detection",
  })
  ...
  async getTimetable(
    ...
    return this.academicService.getWeeklyTimetable(
